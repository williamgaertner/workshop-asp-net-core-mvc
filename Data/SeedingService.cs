...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMvcContext context) // criando injeção de dependencia 
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.SalesRecord.Any() || _context.Seller.Any()) // testando se exite algum dado no banco de dados 
            {
            ...
            {   // copulando banco de dados 
                ...
                _context.Department.AddRange(d1, d2, d3, d4); // adicionando no banco tabela departament

                _context.Seller.AddRange(s1, s2, s3, s4, s5, s6); // adicionando no banco tabela seller

                _context.SalesRecord.AddRange( // adicionando no banco tabela sales record
